            ...
            <div className="p-3 w-1/4">
                ...
                <ul className="border mt-3 rounded h-[calc(100vh_-_162px)] overflow-y-auto">
                    <li className="border-b last:border-b-0">
                        <a href="#" className="flex flex-row justify-start items-center block py-2 px-3 transition delay-75 hover:bg-gray-200">
                            <img src={avatar} className="rounded-full w-16 h-16" alt="" />
                            <div className="ml-3 w-full">
                                <div className="flex flex-row justify-between items-center">
                                    <h3 className="text-1xl font-semibold">Mr User</h3>
                                    <p>2 hrs ago</p>
                                </div>
